from src.pysqldump.query_builder.database import Table
from src.pysqldump.query import Query
...
def test_raw_query():
    ...
    expected = (
        """SELECT `us`.`id`, `us`.`name`, `us`.`city_id`, `cit`.`id`, `cit`.`name`, `cit`.`country`, """
